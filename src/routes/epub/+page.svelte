          ...
          >
            ...
            <tbody class="divide-y divide-border-color">
              ...
              <tr>
                ...
                <td class="py-3 px-3">
                  <code>&lt;figure class="illust-box"&gt;&lt;img class="illust-img" src="../images/hinh-1.jpg" alt="hinh-1"/&gt;&lt;/figure&gt;</code><br />
                  <span class="text-[11px] text-text-mute"
                    >Chèn ảnh minh họa (tên trong ngoặc vuông trùng với tên file ảnh tải lên, hệ thống tự động gắn đúng định dạng file <code>.jpg, .png, .webp...</code>).</span
                  >
                </td>
              </tr>
            </tbody>
