...
## Corpus Check
- 32 files · ~18,555 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 187 nodes · 295 edges · 24 communities (17 shown, 7 thin omitted)
...
Cohesion: 0.17
Nodes (26): analyzeChapterCandidates(), cleanHeaderFooterOcr(), compileCleanKeywords(), convertInline(), convertTxtInline(), endsWithSentencePunctuation(), escapeRegExp(), extractChunkBlocks() (+18 more)
...
### Community 7 - "jszip"
Cohesion: 0.31
Nodes (7): jszip, dependencies, jszip, BOLD_ITALIC_PATTERNS, convertBrackets(), fixMarkdownZip(), ITALIC_PATTERNS
...
- **Why does `jszip` connect `jszip` to `PdfSplitterState`, `.applyGrouping`, `epub-packer.js`?**
